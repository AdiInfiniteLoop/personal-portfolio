  ...
  return (
    ...
    >
      ...
      <form ref={form} onSubmit={sendEmail} className="max-w-2xl mx-auto">
        ...
        ></textarea>
        <button
          className="py-3 px-8 w-max flex items-center justify-between gap-2 bg-black/80 text-white rounded-full mx-auto hover:bg-black duration-500 hover:-translate-y-1"
          type="submit"
        >
          Submit Now
        </button>
